...
<?php
    ...
    $ogImgType = 'image/' . array( 'bpm', 'gif', 'jpg', 'png' )[$imageinfo[2]];
?>
    ...
    <meta property="og:image:type" content="<?php echo $ogImgType; ?>" />
    <?php if ( $protocol == 'https://' ) echo "<meta property=\"og:image:secure_url\" content=\"$ogImg\" />\n"; ?>
